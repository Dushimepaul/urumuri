...
<head>
	...
	<!--favicon-->
	<link rel="icon" href="<?=base_url()?>assets/frontend/img/logo/urumuri.jpeg" type="image/png">
	<!--plugins-->
							...
							<div class="card-body">
								<div class="p-4">
									<div class="mb-3 text-center">
										<img src="<?=base_url()?>assets/frontend/img/logo/urumuri.jpeg" width="60" alt="" />
									</div>
									<div class="text-center mb-4">
										<h5 class="">URUMURI_ICSB</h5>
									...
									<div class="form-body">
										<form action="<?=base_url('Admin/do_login')?>" class="row g-3" method="POST">
											<div class="col-12">
