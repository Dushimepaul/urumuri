            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-briefcase"></i></a></li>
                        <li class="breadcrumb-item active" aria-current="page">Dons de Compétences</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example" class="table table-striped table-bordered table-hover" style="width:100%">
                        ...
                        <tbody>
                            <?php $i=1; foreach ($competences as $value) { ?>
                            <tr>
                                <td><?=$i++;?></td>
                                ...
                                <td>
                                    <?php 
                                        $desc = $value['description_contribution'];
                                        ...
                                        <form action="<?=base_url('Dons/UpdateCompetences')?>" method="POST">
                                            ...
                                            <div class="modal-body row g-3">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <textarea class="form-control" name="description_contribution" rows="5" required><?=$value['description_contribution']?></textarea>
                                                </div>
                                            </div>
...
<div class="modal fade" id="newCompetence" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Nouveau Don de Compétence</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form action="<?=base_url('Dons_Competences/Create')?>" method="POST">
                <div class="modal-body row g-3">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <label class="form-label">Description de la compétence/service</label>
                        <textarea class="form-control" name="description_contribution" rows="5" placeholder="Décrivez comment vous souhaitez aider..." required></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
